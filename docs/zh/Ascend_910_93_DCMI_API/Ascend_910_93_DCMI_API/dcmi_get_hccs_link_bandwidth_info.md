# dcmi\_get\_hccs\_link\_bandwidth\_info<a name="ZH-CN_TOPIC_0000002517638627"></a>
...
<p id="p17458141613201"><a name="p17458141613201"></a><a name="p17458141613201"></a></p>
...
<td class="cellrowborder" valign="top" width="13.700000000000001%" headers="mcps1.1.5.1.2 "><p id="p9378422127"><a name="p9378422127"></a><a name="p9378422127"></a>输出</p>
</td>
...
<p id="p31145383441"><a name="p31145383441"></a><a name="p31145383441"></a>int profiling_time; //采样间隔时间，取值范围1~1000，单位ms</p>
<p id="p7114123814418"><a name="p7114123814418"></a><a name="p7114123814418"></a>double total_txbw; //总发送数据带宽，单位GB/S</p>
<p id="p21141738204412"><a name="p21141738204412"></a><a name="p21141738204412"></a>double total_rxbw; //总接收数据带宽，单位GB/S</p>
<p id="p13114438184414"><a name="p13114438184414"></a><a name="p13114438184414"></a>double tx_bandwidth[DCMI_HCCS_MAX_PCS_NUM]; //单链路发送数据带宽，单位GB/S</p>
<p id="p21151038194417"><a name="p21151038194417"></a><a name="p21151038194417"></a>double rx_bandwidth[DCMI_HCCS_MAX_PCS_NUM];//单链路接收数据带宽，单位GB/S</p>
...
hccs_bandwidth_info.profiling_time = 1000;//采样间隔时间
