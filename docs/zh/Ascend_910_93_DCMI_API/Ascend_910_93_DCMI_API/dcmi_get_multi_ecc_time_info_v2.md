# dcmi\_get\_multi\_ecc\_time\_info\_v2<a name="ZH-CN_TOPIC_0000002517558707"></a>

**函数原型<a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_toc533412077"></a>**

**int dcmi\_get\_multi\_ecc\_time\_info\_v2\(int card\_id, int device\_id, struct dcmi\_multi\_ecc\_time\_data \*multi\_ecc\_time\_data\)**
...
<th class="cellrowborder" valign="top" width="15.989999999999998%" id="mcps1.1.5.1.3"><p id="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p54045009"><a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p54045009"></a><a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p54045009"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="50.019999999999996%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p15569626"><a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p15569626"></a><a name="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_p15569626"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000001251107199_zh-cn_topic_0000001223414423_zh-cn_topic_0000001146259777_row5908907"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p165501755191211"><a name="p165501755191211"></a><a name="p165501755191211"></a>card_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p5550125512124"><a name="p5550125512124"></a><a name="p5550125512124"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="15.989999999999998%" headers="mcps1.1.5.1.3 "><p id="p1855019559123"><a name="p1855019559123"></a><a name="p1855019559123"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50.019999999999996%" headers="mcps1.1.5.1.4 "><p id="p3550175511122"><a name="p3550175511122"></a><a name="p3550175511122"></a>设备ID，当前实际支持的ID通过dcmi_get_card_num_list接口获取。</p>
</td>
</tr>
<tr id="row187731940144017"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p8523478409"><a name="p8523478409"></a><a name="p8523478409"></a>device_id</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p1452447174013"><a name="p1452447174013"></a><a name="p1452447174013"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="15.989999999999998%" headers="mcps1.1.5.1.3 "><p id="p7521477402"><a name="p7521477402"></a><a name="p7521477402"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50.019999999999996%" headers="mcps1.1.5.1.4 "><p id="p1521447194012"><a name="p1521447194012"></a><a name="p1521447194012"></a>芯片ID，通过dcmi_get_device_id_in_card接口获取。取值范围如下：</p>
<p id="p1053164764013"><a name="p1053164764013"></a><a name="p1053164764013"></a>NPU芯片：[0, device_id_max-1]。</p>
<p id="p92659433182"><a name="p92659433182"></a><a name="p92659433182"></a></p>
...
<tr id="row3769175031212"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p14550105541212"><a name="p14550105541212"></a><a name="p14550105541212"></a>multi_ecc_time_data</p>
</td>
<td class="cellrowborder" valign="top" width="16.99%" headers="mcps1.1.5.1.2 "><p id="p355065571214"><a name="p355065571214"></a><a name="p355065571214"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="15.989999999999998%" headers="mcps1.1.5.1.3 "><p id="p555011556129"><a name="p555011556129"></a><a name="p555011556129"></a>struct dcmi_multi_ecc_time_data</p>
</td>
<td class="cellrowborder" valign="top" width="50.019999999999996%" headers="mcps1.1.5.1.4 "><p id="p19634442114114"><a name="p19634442114114"></a><a name="p19634442114114"></a>多比特时间戳信息。</p>
<p id="p9634124234115"><a name="p9634124234115"></a><a name="p9634124234115"></a>struct dcmi_multi_ecc_time_data {</p>
<p id="p1763474224115"><a name="p1763474224115"></a><a name="p1763474224115"></a>unsigned int multi_record_count; //不同地址的多bit错误个数</p>
<p id="p146341542104116"><a name="p146341542104116"></a><a name="p146341542104116"></a>unsigned int multi_ecc_times[MAX_RECORD_ECC_ADDR_COUNT]; //ECC地址出现错误次数</p>
<p id="p66341042114112"><a name="p66341042114112"></a><a name="p66341042114112"></a>};</p>
</td>
</tr>
</tbody>
</table>
...
ret = dcmi_get_multi_ecc_time_info_v2(card_id, device_id, &multi_ecc_time_data);
if (ret != 0){
    //todo：记录日志
    return ret;
}
