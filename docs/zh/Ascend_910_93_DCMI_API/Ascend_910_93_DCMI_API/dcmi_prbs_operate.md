# dcmi\_prbs\_operate<a name="ZH-CN_TOPIC_0000002517558615"></a>
...
<p id="p11571824191912"><a name="p11571824191912"></a><a name="p11571824191912"></a></p>
...
<p id="p111006311183"><a name="p111006311183"></a><a name="p111006311183"></a>unsigned int serdes_prbs_lane_count;//lane的数量，最小值为1，最大值为4</p>
...
**约束说明<a name="section163575864318"></a>**

-   打流前请关闭所有运行的业务。
-   该接口支持在物理机+特权容器场景下使用。
-   driver包安装或NPU复位之后需要等待120s之后才能做打流动作。
-   两端打流场景，必须先开一端tx，再开对端rx；暂不支持开一端txrx。
-   打流动作会使NPU网口down，会产生BMC告警；若后续不关闭打流动作，则网口无法up。
-   打流功能仅支持光模块环回（光模块需要有环回能力）、CDR环回、NPU光纤直连场景。
