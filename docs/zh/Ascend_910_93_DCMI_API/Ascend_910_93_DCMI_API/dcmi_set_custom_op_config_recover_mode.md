# dcmi\_set\_custom\_op\_config\_recover\_mode<a name="ZH-CN_TOPIC_0000002517638621"></a>
...
**参数说明<a name="section216112975615"></a>**
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p173615155277"><a name="p173615155277"></a><a name="p173615155277"></a>设置AI CPU算子免权签持久化功能的开关模式。取值为0或1，默认是0。</p>
<a name="ul73621532714"></a><a name="ul73621532714"></a><ul id="ul73621532714"><li>0：AI CPU算子免权签持久化功能的开关为关闭模式</li><li>1：AI CPU算子免权签持久化功能的开关为开启模式</li></ul>
</td>
</tr>
</tbody>
</table>
