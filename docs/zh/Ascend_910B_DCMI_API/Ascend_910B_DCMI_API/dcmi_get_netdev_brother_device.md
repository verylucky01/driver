# dcmi\_get\_netdev\_brother\_device<a name="ZH-CN_TOPIC_0000002485295496"></a>

**函数原型<a name="section1840010181362"></a>**

**int dcmi\_get\_netdev\_brother\_device\(int card\_id, int device\_id, int \*brother\_card\_id\)**

**功能说明<a name="section13550185093615"></a>**

获取当前NPU模组中有网口互助关系的NPU模组。

**参数说明<a name="section14576161911378"></a>**

<a name="zh-cn_topic_0000002269308857_table3721102412494"></a>
<table><thead align="left"><tr id="zh-cn_topic_0000002269308857_row127491124114913"><th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.1"><p id="zh-cn_topic_0000002269308857_p67494249498"><a name="zh-cn_topic_0000002269308857_p67494249498"></a><a name="zh-cn_topic_0000002269308857_p67494249498"></a>参数名称</p>
</th>
<th class="cellrowborder" valign="top" width="15.15%" id="mcps1.1.5.1.2"><p id="zh-cn_topic_0000002269308857_p37491124164919"><a name="zh-cn_topic_0000002269308857_p37491124164919"></a><a name="zh-cn_topic_0000002269308857_p37491124164919"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="17.169999999999998%" id="mcps1.1.5.1.3"><p id="zh-cn_topic_0000002269308857_p117491224194917"><a name="zh-cn_topic_0000002269308857_p117491224194917"></a><a name="zh-cn_topic_0000002269308857_p117491224194917"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="50.51%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000002269308857_p127491124144914"><a name="zh-cn_topic_0000002269308857_p127491124144914"></a><a name="zh-cn_topic_0000002269308857_p127491124144914"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000002269308857_row12749132418498"><td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000002269308857_p107491624154917"><a name="zh-cn_topic_0000002269308857_p107491624154917"></a><a name="zh-cn_topic_0000002269308857_p107491624154917"></a>card_id</p>
</td>
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000002269308857_p12749122414916"><a name="zh-cn_topic_0000002269308857_p12749122414916"></a><a name="zh-cn_topic_0000002269308857_p12749122414916"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000002269308857_p6749162494917"><a name="zh-cn_topic_0000002269308857_p6749162494917"></a><a name="zh-cn_topic_0000002269308857_p6749162494917"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000002269308857_p57498247497"><a name="zh-cn_topic_0000002269308857_p57498247497"></a><a name="zh-cn_topic_0000002269308857_p57498247497"></a>设备ID，当前实际支持的ID通过dcmi_get_card_list接口获取。</p>
</td>
</tr>
<tr id="zh-cn_topic_0000002269308857_row87494247496"><td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000002269308857_p10749142424913"><a name="zh-cn_topic_0000002269308857_p10749142424913"></a><a name="zh-cn_topic_0000002269308857_p10749142424913"></a>device_id</p>
</td>
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000002269308857_p117498243494"><a name="zh-cn_topic_0000002269308857_p117498243494"></a><a name="zh-cn_topic_0000002269308857_p117498243494"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000002269308857_p974912245493"><a name="zh-cn_topic_0000002269308857_p974912245493"></a><a name="zh-cn_topic_0000002269308857_p974912245493"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000002269308857_p1974915243493"><a name="zh-cn_topic_0000002269308857_p1974915243493"></a><a name="zh-cn_topic_0000002269308857_p1974915243493"></a>芯片ID，通过dcmi_get_device_id_in_card接口获取。取值范围如下：</p>
<p id="zh-cn_topic_0000002269308857_p5749132411491"><a name="zh-cn_topic_0000002269308857_p5749132411491"></a><a name="zh-cn_topic_0000002269308857_p5749132411491"></a>NPU芯片：[0, device_id_max-1]。</p>
<p id="p18312953114811"><a name="p18312953114811"></a><a name="p18312953114811"></a></p>
...
<tr id="zh-cn_topic_0000002269308857_row2749024144914"><td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000002269308857_p574912247499"><a name="zh-cn_topic_0000002269308857_p574912247499"></a><a name="zh-cn_topic_0000002269308857_p574912247499"></a>brother_card_id</p>
</td>
<td class="cellrowborder" valign="top" width="15.15%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000002269308857_p17749182413495"><a name="zh-cn_topic_0000002269308857_p17749182413495"></a><a name="zh-cn_topic_0000002269308857_p17749182413495"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="17.169999999999998%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000002269308857_p1874952414920"><a name="zh-cn_topic_0000002269308857_p1874952414920"></a><a name="zh-cn_topic_0000002269308857_p1874952414920"></a>int *</p>
</td>
<td class="cellrowborder" valign="top" width="50.51%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000002269308857_p574992424916"><a name="zh-cn_topic_0000002269308857_p574992424916"></a><a name="zh-cn_topic_0000002269308857_p574992424916"></a>获取指定模组对应的有网口互助关系的模组。</p>
</td>
</tr>
</tbody>
</table>
