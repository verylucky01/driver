# dcmi\_get\_device\_memory\_info\_v3<a name="ZH-CN_TOPIC_0000002517535347"></a>

**函数原型<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_toc533412077"></a>**

**int dcmi\_get\_device\_memory\_info\_v3\(int card\_id, int device\_id, struct dcmi\_get\_memory\_info\_stru \*memory\_info\)**

**功能说明<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_toc533412078"></a>**

获取芯片的内存信息。

**参数说明<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_toc533412079"></a>**

<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_table10480683"></a>
<table><thead align="left"><tr id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_row7580267"><th class="cellrowborder" valign="top" width="17%" id="mcps1.1.5.1.1"><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10021890"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10021890"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10021890"></a>参数名称</p>
</th>
<th class="cellrowborder" valign="top" width="17.1%" id="mcps1.1.5.1.2"><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p6466753"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p6466753"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p6466753"></a>输入/输出</p>
</th>
<th class="cellrowborder" valign="top" width="15.9%" id="mcps1.1.5.1.3"><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p54045009"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p54045009"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p54045009"></a>类型</p>
</th>
<th class="cellrowborder" valign="top" width="50%" id="mcps1.1.5.1.4"><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p15569626"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p15569626"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p15569626"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_row10560021192510"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p36741947142813"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p36741947142813"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p36741947142813"></a>card_id</p>
</td>
<td class="cellrowborder" valign="top" width="17.1%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p96741747122818"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p96741747122818"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p96741747122818"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="15.9%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p46747472287"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p46747472287"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p46747472287"></a>int</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1467413474281"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1467413474281"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1467413474281"></a>设备ID，当前实际支持的ID通过dcmi_get_card_list接口获取。</p>
</td>
</tr>
<tr id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_row1155711494235"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p7711145152918"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p7711145152918"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p7711145152918"></a>device_id</p>
</td>
<td class="cellrowborder" valign="top" width="17.1%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p671116522914"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p671116522914"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p671116522914"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="15.9%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1771116572910"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1771116572910"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1771116572910"></a>int</p>
</td>
...
<p id="p581262012157"><a name="p581262012157"></a><a name="p581262012157"></a></p>
...
<tr id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_row15462171542913"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10538183417292"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10538183417292"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p10538183417292"></a>memory_info</p>
</td>
<td class="cellrowborder" valign="top" width="17.1%" headers="mcps1.1.5.1.2 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1253820342295"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1253820342295"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p1253820342295"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="15.9%" headers="mcps1.1.5.1.3 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p85381334192914"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p85381334192914"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p85381334192914"></a>struct dcmi_get_memory_info_stru*</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p9538173402917"><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p9538173402917"></a><a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_p9538173402917"></a>返回内存信息，内存信息结构体：</p>
<p id="zh-cn_topic_0000001194907792_p19614181815246"><a name="zh-cn_topic_0000001194907792_p19614181815246"></a><a name="zh-cn_topic_0000001194907792_p19614181815246"></a>struct dcmi_get_memory_info_stru {</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614191862419"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614191862419"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614191862419"></a>unsigned long long memory_size;  //内存大小，单位MB</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p0614018112418"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p0614018112418"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p0614018112418"></a>unsigned long long memory_available;  //可用内存大小，计算方法：free + hugepages_free * hugepagesize</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p166145183243"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p166145183243"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p166145183243"></a>unsigned int freq; //频率MHz</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p061411186248"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p061411186248"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p061411186248"></a>unsigned long hugepagesize; //大页的大小，单位KB</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p96142182240"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p96142182240"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p96142182240"></a>unsigned long hugepages_total; //总大页数量</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614418142414"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614418142414"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614418142414"></a>unsigned long hugepages_free; //可用大页数量</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614181802411"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614181802411"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p10614181802411"></a>unsigned int utiliza; //DDR内存的使用量</p>
<p id="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p1861419181249"><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p1861419181249"></a><a name="zh-cn_topic_0000001251107213_zh-cn_topic_0000001194907792_p1861419181249"></a>unsigned char reserve[60];  //保留</p>
<p id="zh-cn_topic_0000001194907792_p46143186246"><a name="zh-cn_topic_0000001194907792_p46143186246"></a><a name="zh-cn_topic_0000001194907792_p46143186246"></a>};</p>
</td>
</tr>
</tbody>
</table>
...
**约束说明<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_toc533412082"></a>**

推荐使用[dcmi\_get\_device\_hbm\_info](dcmi_get_device_hbm_info.md)。
...
**调用示例<a name="zh-cn_topic_0000001194907792_zh-cn_topic_0000001147936963_toc533412083"></a>**
