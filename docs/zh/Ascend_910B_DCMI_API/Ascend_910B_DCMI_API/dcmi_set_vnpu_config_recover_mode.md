# dcmi\_set\_vnpu\_config\_recover\_mode<a name="ZH-CN_TOPIC_0000002517615365"></a>

**函数原型<a name="zh-cn_topic_0000001277289337_zh-cn_topic_0000001178213212_zh-cn_topic_0000001167998163_toc533412077"></a>**

**int dcmi\_set\_vnpu\_config\_recover\_mode\(unsigned int mode\)**
...
<tbody><tr id="zh-cn_topic_0000001277289337_zh-cn_topic_0000001178213212_zh-cn_topic_0000001167998163_row10560021192510"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.1.5.1.1 "><p id="p6902171113322"><a name="p6902171113322"></a><a name="p6902171113322"></a>mode</p>
</td>
<td class="cellrowborder" valign="top" width="15.02%" headers="mcps1.1.5.1.2 "><p id="p5902111153218"><a name="p5902111153218"></a><a name="p5902111153218"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="17.98%" headers="mcps1.1.5.1.3 "><p id="p1190213117320"><a name="p1190213117320"></a><a name="p1190213117320"></a>unsigned int</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.5.1.4 "><p id="p17902911203215"><a name="p17902911203215"></a><a name="p17902911203215"></a>vNPU的配置恢复使能状态。分为禁用、使能。默认为使能状态。</p>
<a name="ul698662911568"></a><a name="ul698662911568"></a><ul id="ul698662911568"><li>0：禁用</li><li>1：使能</li></ul>
</td>
</tr>
</tbody>
</table>
...
-   设置vNPU配置恢复状态为使能状态后，若重启系统，已创建的vNPU会自动创建。
-   设置vNPU配置恢复状态为禁用状态后，会清空原有配置，且后续创建或销毁vNPU的配置也不会保存，系统重启会自动销毁已创建的vNPU。
