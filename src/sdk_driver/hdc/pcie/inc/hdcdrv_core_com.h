...
struct vhdc_ctrl_msg_pool_check {
    ...
    u32 segment;
    u32 sg_cnt;
    ka_dma_addr_t addr[HDCDRV_HUGE_PACKET_NUM];
...
struct hdc_hotreset_task_info {
    ...
    int hotreset_flag;
    int msg_chan_refcnt;
    ka_task_spinlock_t task_rw_lock;
};
...
#endif
#define HDCDRV_CONN_MIN_TIMEOUT (1 * KA_HZ) /* 1s */
