...
typedef union {
    ...
    struct {
         ...
         * 4'd8: SQCQ_ASYNC_REQ indicates that the software operation occurs and the software operation information is synchronized to ACSQ.
...
typedef union {
    /* Define the struct bits */
    struct {
        /* dfx_rtsq_fsm_sel Time when the selected RTSQ is in the SWAPIN state */
...
typedef union {
    ...
    struct {
        ...
        unsigned int rtsq_swapin_max_ffts_ns : 7;       /* [6:0] */
        unsigned int reserved0               : 1;       /* [7] */
        /* The max number of ACSQ can be used by pcie. */
        unsigned int rtsq_swapin_max_pciedma_ns : 7;       /* [14:8] */
        unsigned int reserved1               : 1;       /* [15] */
        /* The max number of ACSQ can be used by FFTS_AIV */
        unsigned int rtsq_swapin_max_ffts_aiv_only_ns : 7;       /* [22:16] */
...
#define STARS_SWAPIN_CTRL0_NS                   (0x0900) // default val: 0x200C2010
...
typedef union {
    ...
    struct {
        ...
        unsigned int reserved2               : 1;       /* [23] */
        /* The max number of ACSQ can be used by dsa. */
...
#define STARS_SWAPIN_CTRL1_NS                   (0x0904) // default val: 0x08041C0A
...
typedef union {
    ...
    struct {
        ...
        unsigned int rtsq_swapin_max_conds_ns : 7;       /* [6:0] */
        unsigned int reserved0               : 1;       /* [7] */
        /* The max number of ACSQ can be used by sblk topic task. */
        unsigned int rtsq_swapin_max_sblk_cpu_ns : 7;       /* [14:8] */
        unsigned int reserved1               : 1;       /* [15] */
        /* The max number of ACSQ can be used by mblk topic task. */
        unsigned int rtsq_swapin_max_mblk_cpu_ns : 7;       /* [22:16] */
        unsigned int reserved2               : 1;       /* [23] */
        /* The max number of ACSQ can be used by FFTS_AIC */
        unsigned int rtsq_swapin_max_ffts_aic_only_ns : 7;       /* [30:24] */
        unsigned int reserved3               : 1;       /* [31] */
    } bits;
    /* Define an unsigned member */
    unsigned int u32;
...
#define STARS_SWAPIN_CTRL2_NS                   (0x0908) // default val: 0x0C202008
