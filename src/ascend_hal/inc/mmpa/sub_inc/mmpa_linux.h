...
MMPA_FUNC_VISIBILITY VOID mmMb(void);
...
MMPA_FUNC_VISIBILITY mmTimespec mmGetTickCount(void);
...
MMPA_FUNC_VISIBILITY INT32 mmGetOptErr(void);
MMPA_FUNC_VISIBILITY VOID mmSetOptErr(INT32 mmOptErr);
MMPA_FUNC_VISIBILITY INT32 mmGetOptInd(void);
MMPA_FUNC_VISIBILITY VOID mmSetOptInd(INT32 mmOptInd);
MMPA_FUNC_VISIBILITY INT32 mmGetOptOpt(void);
...
MMPA_FUNC_VISIBILITY INT32 mmGetOsType(void);
...
MMPA_FUNC_VISIBILITY mmSize mmGetPageSize(void);
