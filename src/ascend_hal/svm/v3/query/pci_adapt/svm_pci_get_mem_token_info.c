...
int svm_pci_get_mem_token_info(u32 devid, u64 va, u64 size, u32 *token_id, u32 *token_val)
{
...
int svm_pci_get_mem_token_info_init(u32 devid)
{
    svm_get_mem_token_info_ops_register(devid, svm_pci_get_mem_token_info);
    return 0;
}
