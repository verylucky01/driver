...
static void __attribute__ ((constructor(SVM_INIT_PRI_MEDIUM))) svm_ub_op_init(void)
{
    ...
    ret = svm_register_ioctl_dev_init_post_handle(svm_ub_op_register);
