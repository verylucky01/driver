...
struct bbox_plaintext_module_map g_plaintext_module_map[] = {
    ...
    {BBOX_UB,        PLAINTEXT_TABLE_UB,          PLAINTEXT_TABLE_UB,         PLAINTEXT_TABLE_NONE},
...
struct bbox_plaintext_table_map g_plaintext_table_map[] = {
    ...
    {PLAINTEXT_TABLE_UB,                          MODEL_VECTOR_SIZE(UB),
        MODEL_VECTOR_OBJECT(UB),                      BBOX_FILE_NAME_UB},
