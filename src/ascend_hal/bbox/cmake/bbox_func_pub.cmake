...
macro(get_product_name prod_name)
    ...
    elseif(${PRODUCT} STREQUAL "ascend910B")
        set(${prod_name} "milan")
    elseif(${PRODUCT} STREQUAL "ascend950" OR ${PRODUCT} STREQUAL "ascend950esl" OR ${PRODUCT} STREQUAL "ascend910_55" OR ${PRODUCT} STREQUAL "ascend910_55esl" OR ${PRODUCT} STREQUAL "ascend910_96" OR ${PRODUCT} STREQUAL "ascend910_96esl")
        set(${prod_name} "david")
